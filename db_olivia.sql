...
(1, 'Olivia Tri Agustin', 'Jl Punten Kepanjen', 'P', 'RPL'),
(2, 'Nugi Artikasari', 'Kromengan,kab Malang', 'P', 'TKJ'),
(3, 'Ijup Astutik', 'Jl Kramat,kab Malang', 'P', 'TEI'),
(4, 'Lio Malio', 'Kepanjen,Malang', 'L', 'TKR'),
(5, 'Agenta Dirgantara', 'Jl Malang', 'L', 'TSM');
